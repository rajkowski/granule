...
public class CalcDeps {
    ...
    public List<FragmentDescriptor> calcDeps(List<FragmentDescriptor> list, IRequestProxy request,
        ...
        try {
            ...
            String jsPath = (new File(request.getRealPath(((ExternalFragment) baseDescriptor).getFilePath())))
                    .getParentFile()
    ...
    private List<DependencyInfo> buildDependenciesFromFiles(List<FragmentDescriptor> scripts, IRequestProxy request)
            throws IOException {
    ...
    private void resolveDependencies(String require, HashMap<String, DependencyInfo> searchHash,
            List<FragmentDescriptor> resultList, List<FragmentDescriptor> seenList) throws Exception {
