...
public class Tag {
    ...
    public String getDebugString(String text) {
        ...
        sb.append("Name=").append(name).append("\ncontent=").append(content).append("\nbegin=").append(begin)
                .append(" end=").append(end).append("\ncontentBegin=").append(contentBegin).append(" contentEnd=")
                .append(contentEnd).append("\nTag all=").append(text.substring(begin, end)).append("\nTag value=")
                .append(text.substring(contentBegin, contentEnd));
        sb.append("\nAttributes");
