...
public class CompressServlet extends HttpServlet {
    ...
    private void loadVersion() {
        ...
        try {
            InputStream resourceAsStream = PathUtils.getResourceAsStream(this.getClass(),
    ...
    public class CompilerLogFilter implements Filter {
        ...
        public boolean isLoggable(LogRecord lr) {
            return !(lr.getSourceClassName().startsWith(CLOSURE_COMPILER_PACKAGE_NAME)
                    && lr.getLevel().intValue() < Level.WARNING.intValue());
        }
    }
}
