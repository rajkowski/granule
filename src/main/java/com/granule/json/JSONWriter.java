...
public class JSONWriter {
        ...
        if (inObject) {
            if (!keyPlaced) {
                throw new IllegalStateException(
                        "Current containment is a JSONObject, but a key has not been specified to contain a new array");
            }
        } else if (inArray) {
            if (!firstEntry) {
                writer.write(",");
    ...
    public JSONWriter endObject() throws IOException, IllegalStateException {
        ...
        if (!inObject) {
            ...
            if (keyPlaced) {
                throw new IllegalStateException(
                        "Current writer position in an object and has a key placed, but no value has been assigned to the key.  Cannot end.");
            } else {
                writer.write((String) closures.pop());
                // Set our current positional/control state.
                if (!closures.isEmpty()) {
    ...
    public JSONWriter key(String s) throws IOException, IllegalStateException, NullPointerException {
        ...
        if (s == null) {
            ...
            if (!inObject) {
                throw new IllegalStateException(
                        "Current writer position is not inside a JSON Object, a key cannot be placed.");
            } else {
                if (!keyPlaced) {
                    if (firstEntry) {
                        firstEntry = false;
                    ...
                    throw new IllegalStateException(
                            "Current writer position is inside a JSON Object an with an open key waiting for a value.  Another key cannot be placed.");
                }
            }
        }
        return this;
    ...
    public JSONWriter object() throws IOException, IllegalStateException {
        ...
        if (inObject) {
            if (!keyPlaced) {
                throw new IllegalStateException(
                        "Current containment is a JSONObject, but a key has not been specified to contain a new object");
            }
        } else if (inArray) {
            if (!firstEntry) {
                writer.write(",");
    ...
    public JSONWriter value(boolean b) throws IOException, IllegalStateException {
        ...
        if (inArray) {
            ...
            if (keyPlaced) {
                ...
                throw new IllegalStateException(
                        "Current containment is a JSONObject, but a key has not been specified for the boolean value.");
            }
        } else {
    ...
    public JSONWriter value(double d) throws IOException, IllegalStateException {
        ...
        if (inArray) {
            ...
            if (keyPlaced) {
                ...
                throw new IllegalStateException(
                        "Current containment is a JSONObject, but a key has not been specified for the double value.");
            }
        } else {
            throw new IllegalStateException("Writer is currently not in an array or object, cannot write value");
        }
    ...
    public JSONWriter value(long l) throws IOException, IllegalStateException {
        ...
        if (inArray) {
            ...
            if (keyPlaced) {
                ...
                throw new IllegalStateException(
                        "Current containment is a JSONObject, but a key has not been specified for the long value.");
            }
        } else {
            throw new IllegalStateException("Writer is currently not in an array or object, cannot write value");
        }
    ...
    public JSONWriter value(int i) throws IOException, IllegalStateException {
        ...
        if (inArray) {
            ...
            if (keyPlaced) {
                ...
                throw new IllegalStateException(
                        "Current containment is a JSONObject, but a key has not been specified for the int value.");
            }
        } else {
            throw new IllegalStateException("Writer is currently not in an array or object, cannot write value");
        }
    ...
    public JSONWriter value(short s) throws IOException, IllegalStateException {
        ...
        if (inArray) {
            ...
            if (keyPlaced) {
                ...
                throw new IllegalStateException(
                        "Current containment is a JSONObject, but a key has not been specified for the short value.");
            }
        } else {
            throw new IllegalStateException("Writer is currently not in an array or object, cannot write value");
        }
