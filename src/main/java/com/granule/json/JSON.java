...
public class JSON {
     ...
     * @throws NullPointerException Thrown if reader is null
     */
    public static JSONArtifact parse(Reader reader, boolean order, boolean strict)
     ...
     * @throws NullPointerException Thrown if reader is null
     */
    public static JSONArtifact parse(InputStream is, boolean order, boolean strict)
            throws JSONException, NullPointerException {
        if (is != null) {
     ...
     * @throws NullPointerException Thrown if str is null
     */
    public static JSONArtifact parse(String str, boolean order, boolean strict)
            throws JSONException, NullPointerException {
        if (str != null) {
