        ...
        switch (lastChar) {
            ...
            case 'f':
                ...
                if (!this.strict) {
                    ...
                    throw new IOException("Unexpected unquoted string literal: [" + ident
                            + "].  Unquoted strings are not allowed in strict mode");
                }
            case '/':
                if (!this.strict) {
                    ...
                    throw new IOException("Unexpected character / encountered " + onLineCol()
