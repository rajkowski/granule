...
public class BeanSerializer {
     ...
     */
    public static JSONArtifact toJson(Object obj, boolean includeSuperclass)
     ...
     * @throws com.granule.json.JSONException Thrown if a JSON conversion error occurs.
     */
    private static JSONArtifact introspectBean(Object obj, boolean includeSuperclass, ArrayList parsedObjects)
                        ...
                        if (keys != null) {
                            while (keys.hasNext()) {
                                ...
                                if (key != null && !key.equals("_classname") && !key.equals("_type")) {
                                    ...
                                    String setter = "set" + Character.toUpperCase(key.charAt(0))
                                    ...
                                    if (val != null) {
                                        ...
                                        if (String.class == vClazz) {
                                            ...
                                            if (jObj.get("_classname") != null
                                                    && "JavaClass".equals(jObj.get("_type"))) {
                                                val = fromJson(jObj);
                                                vC = val.getClass();
                                            }
