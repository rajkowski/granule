        ...
        if (!JSONObject.isValidObject(element)) {
            try {
                ...
                throw new IllegalArgumentException("Object of type: [" + element.getClass().getName()
                        + "] could not be converted to a JSON representation.");
            }
        }
            ...
            if (val != null) {
                if (Boolean.class.isAssignableFrom(val.getClass())) {
                    ...
                    throw new JSONException(
                            "Value at index: [" + index + "] was not a boolean or string value of 'true' or 'false'.");
                    ...
                    if (str.equals("true")) {
                        ...
                        throw new JSONException("Value at index: [" + index
                                + "] was not a boolean or string value of 'true' or 'false'.");
                    }
                }
            } else {
